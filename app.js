...
//         list += `<li>${globalArr[i]} <button class="button-delete" onclick="deleteDisplay(${i})">DELETE</button> <button class="button-edit" onclick="editDisplay()">EDIT</button> </li>`;
//     }
...
//     var list = "";
//     for (var i = 0; i < globalArr.length; i++) {
//         list += `<li>${globalArr[i]} <button class="button-delete" onclick="deleteDisplay(${i})">DELETE</button></li>`;
//     }
...
//     var editWork = prompt("Type the edit thing")

//     globalArr.splice(index , 0 , editWork);
//     for (var i = 0; i < globalArr.length; i++) {
//         list += `<li>${globalArr[i]} <button class="button-delete" onclick="deleteDisplay(${i})">DELETE</button></li>`;
//     }
